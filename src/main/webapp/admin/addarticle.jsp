...
<body>
	<nav class="breadcrumb">
		...
		新增网站内容 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="article/createArticle.action" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="article/addArticle.action" name="myform"
			method="post">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="radio" name="istop" value="是" title="是" checked>是 &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
						name="istop" value="否" title="否">否
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">是否轮播</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="radio" name="isflv" value="是" title="是" checked>是 &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
						name="isflv" value="否" title="否">否
				</div>
			</div>
			<div class="row cl">
