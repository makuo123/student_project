...
<body>
	<nav class="breadcrumb">
		...
		新增科室 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="dept/createDept.action"
		...
		<form class="form form-horizontal" id="form-article-add" action="dept/addDept.action" name="myform" method="post">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="deptname" class="input-text" id="deptname" placeholder="请输入科室名称" />
				</div>
			</div>
			<div class="row cl">
