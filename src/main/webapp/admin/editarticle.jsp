	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="article/updateArticle.action" name="myform"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="radio" name="istop" value="是" title="是" ${article.istop == "是"?"checked":""}>是
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="istop" value="否" title="否" ${article.istop == "否"?"checked":""}>否
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">是否轮播</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="radio" name="isflv" value="是" title="是" ${article.isflv == "是"?"checked":""}>是
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="isflv" value="否" title="否" ${article.isflv == "否"?"checked":""}>否
				</div>
			</div>
			<div class="row cl">
