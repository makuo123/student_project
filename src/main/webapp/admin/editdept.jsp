...
<body>
	<nav class="breadcrumb">
		...
		编辑科室<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="dept/updateDept.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">科室名称</label>
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="deptid" id="deptid" value="${dept.deptid}" /><input type="hidden" name="addtime"
						id="addtime" value="${dept.addtime}" /> <input type="hidden" id="basepath" value="<%=basePath%>" />
