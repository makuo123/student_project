...
<body>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<form class="form form-horizontal" action="login/login.action" name="myform" method="post" onSubmit="return checkLogin()">
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input type="radio" id="role" name="role" value="系统用户">系统用户 &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" id="role" name="role"
							value="医生用户" checked>医生用户
					</div>
				</div>
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						<input type="submit" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;"> <input type="reset"
	...
	<div class="footer">2020 &copy; 后台管理系统 All Rights Reserved</div>
</body>
</html>
<%
