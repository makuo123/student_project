...
<body>
	<nav class="breadcrumb">
		...
		医生用户列表 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		...
		<form action="doctor/deleteDoctorByIds.action" method="post" id="myform" name="myform">
			<table class="table table-border table-bordered table-bg">
				<thead>
					<tr>
						<th scope="col" colspan="13">医生用户列表</th>
					</tr>
					<tr class="text-c">
				...
				<c:forEach items="${doctorList}" var="doctor">
					<tr class="text-c">
						<td><input type="checkbox" value="${doctor.doctorid}" name="doctorid"></td>
						...
						<td>${doctor.xueli}</td>
						<td>${doctor.duty}</td>
						<td><a href="doctor/getDoctorById.action?id=${doctor.doctorid}"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp;<a
