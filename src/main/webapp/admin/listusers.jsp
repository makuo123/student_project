...
<body>
	...
	<div class="page-container">
		...
		<form action="users/deleteUsersByIds.action" method="post" id="myform" name="myform">
			<table class="table table-border table-bordered table-bg">
				<thead>
					<tr>
						<th scope="col" colspan="11">网站用户列表</th>
					</tr>
					<tr class="text-c">
				...
				<c:forEach items="${usersList}" var="users">
					<tr class="text-c">
						<td><input type="checkbox" value="${users.usersid}" name="usersid"></td>
