...
<body>
	<nav class="breadcrumb">
		...
		医嘱查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="6">医嘱查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">挂号单</th>
					<th class="center">用户</th>
					<th class="center">医生</th>
					<th class="center">医嘱内容</th>
					<th class="center">日期</th>
				</tr>
			</thead>
			<c:forEach items="${adviceList}" var="advice">
				<tr class="text-c">
					<td class="center">${advice.ordercode}</td>
					<td class="center">${advice.realname}</td>
					<td class="center">${advice.doctorname}</td>
		...
		<div class="text-c">
			<form action="advice/queryAdviceByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="ordersid">按挂号单查询</option>
						<option value="usersid">按用户查询</option>
						<option value="doctorid">按医生查询</option>
						<option value="contents">按医嘱内容查询</option>
