...
<body>
	<nav class="breadcrumb">
		...
		挂号类型查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="4">挂号类型查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">类型名称</th>
					<th class="center">类型收费</th>
		...
		<div class="text-c">
			<form action="cate/queryCateByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="price">按类型收费查询</option>
