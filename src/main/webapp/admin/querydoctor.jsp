...
<body>
	<nav class="breadcrumb">
		...
		医生用户查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="12">医生用户查询</th>
				</tr>
				<tr class="text-c">
		...
		<div class="text-c">
			<form action="doctor/queryDoctorByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						...
						<option value="doctorname">按医生姓名查询</option>
						<option value="sex">按性别查询</option>
						<option value="birthday">按出生日期查询</option>
						<option value="deptid">按所在科室查询</option>
						<option value="graduate">按毕业院校查询</option>
						<option value="xueli">按学历查询</option>
						<option value="duty">按职务查询</option>
