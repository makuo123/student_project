...
<body>
	<nav class="breadcrumb">
		...
		个人信息<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="doctor/userinfo.action"
			title="刷新"> <i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="doctor/personal.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">用户名</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="username" class="input-text" id="username" value="${doctor.username}" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">${doctor.deptname}</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">${doctor.duty}</div>
			</div>
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="doctorid" id="doctorid" value="${doctor.doctorid}" /><input type="hidden"
						name="password" id="password" value="${doctor.password}" /> <input type="hidden" name="deptid" id="deptid"
						value="${doctor.deptid}" /> <input type="hidden" name="duty" id="duty" value="${doctor.duty}" /> <input
						type="hidden" name="contents" id="contents" value="${doctor.contents}" /> <input type="hidden" name="image"
						id="image" value="${doctor.image}" /> <input type="hidden" id="basepath" value="<%=basePath%>" />
