...
$("#safesid").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#safesid").after("<span id='safesid_msg' style='color: red'>提示问题不能为空</span>");
			}
	});
...
$("#answer").blur(
		function() {
			...
			var name = $(this).val();
			if (name == "" || name == null) {
				$("#answer").after("<span id='answer_msg' style='color: red'>问题答案不能为空</span>");
			}
	});
