...
<div id="top_dh_box">
	...
	<div id="top_dh_01">
		<div id="sddm">
			...
			<li><table width="120" border="0" cellpadding="0" cellspacing="0" class="dh_bj01">
					<tr>
						<td height="55" align="center"><a href="index/doctor.action">医生信息</a></td>
					</tr>
				</table></li>
			<c:if test="${sessionScope.userid != null }">
				<li><table width="120" border="0" cellpadding="0" cellspacing="0" class="dh_bj01">
						<tr>
							<td height="55" align="center"><a href="list.asp?sort_id=663" onmouseover="mopen('m663')"
								onmouseout="mclosetime()">用户菜单</a></td>
						</tr>
					</table>
					<div id="m663" onMouseOver="mcancelclosetime()" onMouseOut="mclosetime()">
						<table border="0" cellpadding="0" cellspacing="0" class="top_dh_02">
							<tr>
								<td align=left><table width="100" border="0" cellpadding="0" cellspacing="0" class="xux"
							...
							<tr>
								<td align=left><table width="100" border="0" cellpadding="0" cellspacing="0" class="xux"
										onMouseOver="this.bgColor='#F5F5F5';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
										<tr>
											<td height="40"><a href="index/preComplains.action"><img src="themes/nzblue/images/biao.gif"
													border="0">&nbsp;意见反馈</a></td>
										</tr>
									</table></td>
							</tr>
							<tr>
								<td align=left><table width="100" border="0" cellpadding="0" cellspacing="0" class="xux"
										onMouseOver="this.bgColor='#F5F5F5';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
										<tr>
											<td height="40"><a href="index/myComplains.action"><img src="themes/nzblue/images/biao.gif"
													border="0">&nbsp;我的意见反馈</a></td>
										</tr>
									</table></td>
							</tr>
							<tr>
								<td align=left><table width="100" border="0" cellpadding="0" cellspacing="0" class="xux"
										onMouseOver="this.bgColor='#F5F5F5';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
										<tr>
											<td height="40"><a href="index/preOrders.action"><img src="themes/nzblue/images/biao.gif" border="0">&nbsp;预约挂号</a></td>
										</tr>
									</table></td>
							</tr>
							<tr>
								<td align=left><table width="100" border="0" cellpadding="0" cellspacing="0" class="xux"
										onMouseOver="this.bgColor='#F5F5F5';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#ffffff">
										<tr>
											<td height="40"><a href="index/myOrders.action"><img src="themes/nzblue/images/biao.gif" border="0">&nbsp;我的预约挂号</a></td>
										</tr>
									</table></td>
							</tr>
						</table>
