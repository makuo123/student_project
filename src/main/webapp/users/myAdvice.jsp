			...
			<tr>
				<td align="center" valign="top" bgcolor="#FFFFFF" class="bg_qc">
					<div
						...
						&nbsp;&nbsp;您的位置：<a href="index/index.action">首页</a>&nbsp;&gt;&nbsp;我的医嘱
					</div>
							...
							<td align="left">
								<div class="z" id="z">
									<table width="99%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
										<tr>
											<td height="30" colspan="9" align="left" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">我的医嘱</td>
										</tr>
										<tr>
											<td align="center" bgcolor="#FFFFFF">挂号单</td>
											<td align="center" bgcolor="#FFFFFF">用户</td>
											<td align="center" bgcolor="#FFFFFF">医生</td>
											<td align="center" bgcolor="#FFFFFF">医嘱内容</td>
