			...
			<tr>
				<td align="center" valign="top" bgcolor="#FFFFFF" class="bg_qc">
					<div
						...
						&nbsp;&nbsp;您的位置：<a href="index/index.action">首页</a>&nbsp;&gt;&nbsp;找回密码2
					</div>
					...
					<form action="index/step2.action" method="post" name="myform">
						<table width="46%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
							<tr>
								<td height="30" colspan="2" align="center" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">找回密码2</td>
							</tr>
							<tr>
								<td width="80" height="50" align="right" bgcolor="#FFFFFF">用户账号：</td>
								<td bgcolor="#FFFFFF">${username }<input type="hidden" name="username" id="username" value="${username }" /></td>
							</tr>
							<tr>
								<td height="50" align="right" bgcolor="#FFFFFF">提示问题：</td>
								<td bgcolor="#FFFFFF">${questions }<input type="hidden" name="safesname" id="safesname"
									value="${questions }" /></td>
							</tr>
							<tr>
								<td height="50" align="right" bgcolor="#FFFFFF">答案：</td>
								<td bgcolor="#FFFFFF"><input type="text" name="answer" style="width: 260px; height: 30px" id="answer"
									placeholder="请输入答案" /></td>
							</tr>
							<tr>
