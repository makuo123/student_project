			...
			<tr>
				<td align="center" valign="top" bgcolor="#FFFFFF" class="bg_qc">
					<div
						...
						&nbsp;&nbsp;您的位置：<a href="index/index.action">首页</a>&nbsp;&gt;&nbsp;找回密码
					</div>
					...
					<form action="index/login.action" method="post" name="myform">
						<table width="46%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
							<tr>
								<td height="30" colspan="2" align="center" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">找回密码</td>
							</tr>
							<tr>
							...
							<tr>
								<td bgcolor="#FFFFFF" colspan="2" align="center"><label> <a href="index/preLogin.action"><font
											color="red">返回登录</font></a>
								</label></td>
							</tr>
						</table>
					</form>
