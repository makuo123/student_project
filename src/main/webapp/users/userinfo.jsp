				...
				<td align="center" valign="top" bgcolor="#FFFFFF" class="bg_qc">
					...
					<form action="index/personal.action" name="myform">
						<table width="56%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
							<tr>
								<td height="30" colspan="2" align="center" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">个人信息
								</td>
							</tr>
							<tr>
								...
								<td bgcolor="#FFFFFF">${sessionScope.users.username }<input type="hidden" name="username" id="username"
									...
									value="${sessionScope.users.regdate }" /><input type="hidden" name="answer" id="answer"
									value="${sessionScope.users.answer }" /><input type="hidden" name="safesid" id="safesid"
									value="${sessionScope.users.safesid }" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td bgcolor="#FFFFFF"><input type="radio" name="sex" id="sex" value="男" ${users.sex == "男"?"checked":""} />男
									&nbsp;&nbsp; <input type="radio" name="sex" id="sex" value="女" ${users.sex == "女"?"checked":""} />女</td>
							</tr>
							<tr>
